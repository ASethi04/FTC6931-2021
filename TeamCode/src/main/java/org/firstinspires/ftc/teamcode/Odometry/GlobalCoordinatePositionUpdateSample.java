...
public class GlobalCoordinatePositionUpdateSample extends LinearOpMode {
    ...
    public static final double MAX_RPM = MOTOR_CONFIG.getMaxRPM();

    //Hardware map names for the encoder wheels. Again, these will change for each robot and need to be updated below
    String verticalLeftEncoderName = "BLWheelandLeftOdometry", verticalRightEncoderName = "BRWheelandRightOdometry", horizontalEncoderName = "FLWheelandCenterOdometry";
